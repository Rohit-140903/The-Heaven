...
//       alert("Your 5-minute reservation has expired. Redirecting to home page.");
//       navigate("/");
//       return;
//     }
...
//           fontWeight: "bold",
//           fontSize: "18px",
//           color: timerExpired ? "red" : "black",
//         }}
//       >
//         Reservation time left: {formatTimer(secondsLeft)}
//       </p>
...
export default function AddressPageCheckout() {
  ...
  const makePayment = async (e) => {
    ...
    try {
      const user = localStorage.getItem(import.meta.env.VITE_AUTH_TOKEN);
      const userEmail = user?.email;
      await fetch("http://localhost:4000/clientDetails", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ email: userEmail, address }),
      });
